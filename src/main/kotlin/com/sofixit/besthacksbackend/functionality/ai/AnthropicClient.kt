...
class AnthropicClient(
  ...
  companion object {
    ...
    val SYSTEM_PROMPT = """You are an assistant specializing in optimizing job resumes that would make the candidate more likely to get hired.
      ...
      |3. Do not change the order of the section and do not translate the section names to other languages (keep them in English in CAPS LOCK).
      |4. Structure the optimized resume in the following format:
      |
      |OVERVIEW:
