...
class ConvertApiClient(
  ...
  private val templatingEngine: ResumeTemplatingEngine
) {
  ...
  private suspend fun getPdfUriFromHtml(filename: String, content: String): String? = withContext(Dispatchers.IO) {
    ConvertApi.convert(
      "html", "pdf",
      arrayOf(
